...
# Header
# -------------------------------------------------------------------------
# - Test code: xq-s-flow-sih-oi-all5
...
Feature: xq-s-flow-sih-oi-all5
    ...
    Scenario Outline: Add Lines
        ...
        Then the user adds the text <VACITM1> in selected cell and hits enter key


        Examples:
            | LIN | ITMREF   | QTY  | GROPRI  | XQCFOP | XQOICMS | XQCSTICMS | XQCENQ | XQSTISS | XQEXISS | VACITM1 |
            | 1   | "BMS001" | "21" | "15.95" | "6101" | "0"     | "00"      | "999"  | ""      | ""      | ""      |
            | 2   | "SER001" | "5"  | "25.36" | "6101" | ""      | ""        | ""     | "1"     | "1"     | "BRL"   |
    ...
    Scenario: Open Items
        ...
        And the value of the selected cell is "567.3626"
