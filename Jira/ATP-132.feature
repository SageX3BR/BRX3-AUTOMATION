...
#-------------------------------------------------------------------------
#- Test code: ATP-132
#- Description: Cenário de Geração dos Arquivos de Integração - Cenário 3 - Notaent
#- Jira:
#- Legislation: BRA
...
Feature: ATP-132
    ...
    Scenario: 003. Arquivos - Sales (txt)
        ...
        And the selected log panel includes the message "notaent.txt file has been sucessfully created"
