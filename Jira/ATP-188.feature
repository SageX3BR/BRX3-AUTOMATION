...
# Header
# -------------------------------------------------------------------------
# - Test code: ATP-188 - Reforma Tributaria - Cenario Completo de Vendas - SOH > SDH > SIH
# - OBS: Este cenário está considerando a tributação Diferida e informado elementos de faturação Frete e Desconto
# - Jira: X3DEV-8402
...
# - Updated date:
# - Status: Done
# - Parametrizações: RTAX 1021 / Cliente BR016 / CFOP 6102-9
###########################################################################
...
Feature: ATP-188
    ...
    Scenario: 005. Validação Impostos Encomenda SOH
        ...
        And the value of the selected text field is "6.43"
        ...
        And the value of the selected text field is "0.71"
    ...
    Scenario: 015. Validar Tags no XML
        ...
        And the value of the selected text field contains "<vBC>1190.00</vBC>"
        And the value of the selected text field contains "<vIBSUF>0.71</vIBSUF>"
        And the value of the selected text field contains "<vCBS>6.43</vCBS>"
