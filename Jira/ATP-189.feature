...
# Header
# -------------------------------------------------------------------------
# - Test code: ATP-189 - Reforma Tributaria - Cenario Completo de Vendas - SOH > SDH > SIH
# - OBS: Este cenário está considerando 2 Linhas sendo uma com tributação Diferida e outra Normal e informado elementos de faturação Frete e Desconto
# - Jira: X3DEV-8402
...
# - Updated date:
# - Status: Done
# - Parametrizações: RTAX 1020 e 1021 / Cliente BR016 / CFOP 6102-9
###########################################################################
...
Feature: ATP-189
    ...
    Scenario Outline: 003. Add Lines
        ...
        Examples:
            | LIN | ITMREF   | QTY | GROPRI   | XQCSTIS | XQCCTIS | XQCSTCBS | XQCCTCBS |
            | 1   | "BMS001" | "1" | "500.00" | ""      | ""      | "000"    | "000001" |
            | 2   | "BMS002" | "1" | "500.00" | ""      | ""      | "200"    | "200047" |
    ...
    Scenario: 005. Validação Impostos Encomenda SOH
        ...
        And the value of the selected text field is "8.57"
        ...
        And the value of the selected text field is "0.96"
    ...
    Scenario: 015. Validar Tags no XML
        ...
        And the value of the selected text field contains "<CST>200</CST>"
        And the value of the selected text field contains "<cClassTrib>200047</cClassTrib>"
        ...
        And the value of the selected text field contains "<vIBSUF>0.96</vIBSUF>"
        And the value of the selected text field contains "<vCBS>8.57</vCBS>"
