...
#-------------------------------------------------------------------------
#- Test code: ATP-130
#- Description: Cenário de Geração dos Arquivos de Integração - Cenário 1 - Notasai (txt)
#- Jira:
#- Legislation: BRA
...
Feature: ATP-130
    ...
    Scenario: 003. Arquivos - Sales (txt)
        ...
        And the selected log panel includes the message "notasai.txt file has been sucessfully created"
