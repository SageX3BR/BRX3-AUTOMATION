...
# Header
# -------------------------------------------------------------------------
# - Test code: ATP-194 - Cenario Completo de Vendas - SOH > SDH > SIH com Desconto informado na Linha
# - Jira: X3DEV-9746
...
# - Updated date:
# - Status: Done
# - Parametrizações: GESPRSS parametrizado para Desconto1 como %
###########################################################################
...
Feature: ATP-194
    ...
    Scenario Outline: 003. Add Lines
        ...
        Examples:
            | LIN | ITMREF   | QTY | GROPRI    | DISCRGVAL1 | XQCFOP | XQCSTIS | XQCCTIS  | XQCSTCBS | XQCCTCBS |
            | 1   | "BMS001" | "2" | "1000.00" | "4.00"     | "6102" | "000"   | "000001" | "000"    | "000001" |
    ...
    Scenario: 005. Validação Impostos Encomenda SOH
        ...
        And the value of the selected text field is "80.00"
    ...
    Scenario: 007. Picking SOH>SDH
        ...
        And the user selects the item with the stored text with key "SOHNUM" and with the text containing "BR001" of the picking list panel
    ...
    Scenario: 009. Validação Impostos Expedição SDH
        ...
        Then the user selects the text field with name: "Total discount"
        And the value of the selected text field is "80.00"
        #BUG Interno.. Deveria gerar 80,00
    ...
    Scenario: 015. Validar Tags no XML
        ...
        And the value of the selected text field contains "<vDesc>80.00</vDesc>"
