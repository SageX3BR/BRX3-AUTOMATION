...
# -------------------------------------------------------------------------
# - Test code: ATP-159
# - Description: Sistema envia o grupo de tributação regular para as CSTs 550 CCT 550001 de IBS/CBS
# - Legislation: BRA
...
Feature: ATP-159
    ...
    Scenario: 002. ENCOMENDA DE VENDA GESSOH
        ...
        And the user writes "BR018" to the selected text field and hits tab key
    ...
    Scenario Outline: 003. Add Lines
        ...
        Examples:
            ...
            | 1   | "BMS001" | "1" | "1500.00" | "6102" | "550"    | "550001" |
    ...
    Scenario: 005. Validação Impostos Encomenda SOH
        ...
        And the value of the selected text field is "1,500.00"
        And the user selects the text field with name: "Base cálculo CBS"
        And the value of the selected text field is "1,500.00"
        And the user selects the text field with name: "Reg. CBS tax. value"
        And the value of the selected text field is "13.50"
        And the user selects the text field with name: "Base cálculo IBS Est."
        And the value of the selected text field is "1,500.00"
        And the user selects the text field with name: "Reg. UF IBS tax. value"
        And the value of the selected text field is "1.50"
    ...
    Scenario: 007. Picking SOH>SDH
        ...
        And the user selects the item with the stored text with key "SOHNUM" and with the text containing "BR018" of the picking list panel
    ...
    Scenario: 015. Validar Tags no XML
        ...
        And the value of the selected text field contains "<CST>550</CST>"
        And the value of the selected text field contains "<cClassTrib>550001</cClassTrib>"
        And the value of the selected text field contains "<CSTReg>000</CSTReg>"
        And the value of the selected text field contains "<cClassTribReg>000001</cClassTribReg>"
        And the value of the selected text field contains "<vTribRegIBSUF>1.50</vTribRegIBSUF>"
        And the value of the selected text field contains "<vTribRegCBS>13.50</vTribRegCBS>"
