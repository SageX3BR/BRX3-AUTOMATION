...
# -------------------------------------------------------------------------
# - Test code: ATP-22
# - Description: Garantir cadastro com mesmo CNPJ e IE para Fornecedor
# - Jira: X3DEV-358
...
Feature: ATP-22
    ...
    Scenario: 2.Criação de Cadastro de Fornecedor com o mesmo CNPJ e IE
        ...
        And the user writes "TF001" to the selected text field and hits tab key

    Scenario: 3.Address code
        Given the user selects the fixed data table for x3 field name: "BPABPS_ARRAY_NBADR"
        And the user selects last editable cell with X3 field name: "BPABPS_CODADR"
        ...
        And the user selects the text field with name: "Inscrição Estadual"
