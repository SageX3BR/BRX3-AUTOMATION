...
Feature: ATP-147
    ...
    Scenario Outline: Lines
        ...
        And the user selects last fixed cell with X3 field name: "WE7ALLXQ0_QTYUOM"
        And the user adds the text <QTYUOM> in selected cell
        And the user selects last fixed cell with X3 field name: "WE7ALLXQ0_GROPRI"
        And the user adds the text <GROPRI> in selected cell
        And the user selects last fixed cell with X3 field name: "WE7ALLXQ0_XQCFOP"
        And the user adds the text <XQCFOP> in selected cell
        And the user selects last fixed cell with X3 field name: "WE7ALLXQ0_XQORIGEMICMS"
        And the user adds the text <XQORIGEMICMS> in selected cell
        And the user selects last fixed cell with X3 field name: "WE7ALLXQ0_XQCSTICMS"
        And the user adds the text <XQCSTICMS> in selected cell and hits tab key
        And the user selects last fixed cell with X3 field name: "WE7ALLXQ0_XQCSTIPI"
        And the user adds the text <XQCSTIPI> in selected cell
        And the user selects last fixed cell with X3 field name: "WE7ALLXQ0_XQCSTPIS"
        And the user adds the text <XQCSTPIS> in selected cell
        And the user selects last fixed cell with X3 field name: "WE7ALLXQ0_XQCSTCOF"
        Then the user adds the text <XQCSTCOF> in selected cell
        And the user selects last fixed cell with X3 field name: "WE7ALLXQ0_XQCENQ"
    ...
    Scenario: 004. Referenced documents
        ...
        And the user adds the text "41240342580092002039551500000030891891813091" in selected cell and hits tab key
    ...
    Scenario: 005. Tax Summary
        Given the user clicks the "Tax Summary" tab selected by title
        Then the user selects the text field with name: "ICMS due from operation"
