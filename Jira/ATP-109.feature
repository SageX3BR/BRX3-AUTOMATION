...
#-------------------------------------------------------------------------
#- Test code: ATP-109
#- Description: Garantir que o PDF da DAMDFE seja anexado ao transmitir e autorizar uma MDF-e
#- Jira:
#- Legislation: BRA
...
Feature: ATP-109
    ...
    Scenario: 9. Rodoviário - Condutor
        ...
        And the user writes "ABC3335" to the selected text field and hits tab key
    ...
    Scenario: 19. Chave MDFe
        And the user selects the text field with X3 field name: "XQMDFE2_CHAVEMDFE"
        And the user stores the value of the selected text field with the key: "CHAVE_MDFE"

    Scenario: 20. Attachments/Anexos
        ...
        #And the user selects first row of the selected data table
        Then the user selects the fixed cell with X3 field name: "AOBJTXT_ORINAM" and row number: 2
        And the value of the selected cell has string pattern "*[CHAVE_MDFE]*"
