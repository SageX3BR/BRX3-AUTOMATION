...
#-------------------------------------------------------------------------
#- Test code: ATP-135
#- Description: Cenário de Geração dos Arquivos de Integração - Cenário 6 - Bloco K
#- Jira:
#- Legislation: BRA
...
Feature: ATP-135
    ...
    Scenario: 003. Arquivos - Sales (txt)
        ...
        And the selected log panel includes the message "BLOCOK.txt file has been sucessfully created"
