...
# Header
# -------------------------------------------------------------------------
# - Test code: xq-p-flow-poh-pih-imp-ii
# - Description: Import receipt create via picking a order with
# Sum II value to invoice total in the NF-e Summary
# - Jira: NA
# - Legislation: BRA
...
Feature: xq-p-flow-poh-pih-imp-ii
    ...
    Scenario Outline: 12. Lines POH
        ...
        Examples:
            ...
            | 1   | "BMS001" | "32"   | "25.69" | "3101" | "0"          | "00"      | "999"  | "49"     | "01"     | "01"     |
            | 2   | "BMS002" | "24"   | "35.32" | "3101" | "0"          | "00"      | "999"  | "49"     | "01"     | "01"     |
    ...
    Scenario: 15. Header PIH
        ...
        And the user stores the value of the selected text field with the key: "DOCSUP046"
        Then the user clicks the Close page action icon on the header panel
    ...
    Scenario: 17. Management
        ...
        And the user writes the stored text with key "DOCSUP046" in the selected text field and hits tab key
    ...
    Scenario Outline: 19. Import Declaration
        ...
        Examples:
            ...
            | "1"    | "1234567890" | "123ABC" | "1.36"  | "2.58"    | "9.32"    | "4.62" | "1.65"   | "Porto de Paranagua" | "PR"     |
            | "2"    | "1234567890" | "ABC123" | "2.56"  | "1.65"    | "7.64"    | "5.28" | "3.15"   | "Porto de Paranagua" | "PR"     |
    ...
    Scenario: 9. Resume
        ...
        And the value of the selected text field is "1,933.35"
        Then the user clicks the Close page action icon on the header panel
