...
# Header
# -------------------------------------------------------------------------
# - Test code: xq-s-flow-sih-modbc4-cst30
...
Feature: xq-s-flow-sih-modbc4-cst30
    ...
    Scenario: 2. Create a Invoice
        ...
        #And the user selects row that has the text "ALL     Full entry invoice" in column with header: ""
