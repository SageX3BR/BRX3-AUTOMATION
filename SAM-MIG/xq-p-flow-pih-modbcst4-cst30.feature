...
Feature:xq-p-flow-pih-modbcst4-cst30
    ...
    Scenario: Creation PIH
        ...
        And the user stores the value of the selected text field with the key: "DOCSUP018"
        ...
        And the user writes the stored text with key "DOCSUP018" in the selected text field and hits tab key
    ...
    Scenario Outline: Add Lines
        ...
        Examples:
            ...
            | 1   | "BMS001" | "5"    | "17.58" | "2101" | "4"       | "0"          | "30"      | "999"  |
            | 2   | "BMS001" | "7"    | "19.85" | "2101" | "4"       | "0"          | "30"      | "999"  |
