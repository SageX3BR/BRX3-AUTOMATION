...
Feature: xq-s-flow-sqh-soh-sdh-sih-01
    ...
    Scenario: 7. Create document
        ...
        And the user stores the value of the selected text field with the key: "SDH_NUM06"
    ...
    Scenario: 9. Left List
        ...
        And the user adds the stored text with key "SDH_NUM06" in selected cell and hits enter key
        And the user selects cell that matches exact with the stored text with the key: "SDH_NUM06" and column header: "Delivery"
        And the user clicks on the selected cell
