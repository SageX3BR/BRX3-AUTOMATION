...
# Header
# -------------------------------------------------------------------------
# - Test code: xq-p-flow-poh-pth-imp-icms
...
Feature: xq-p-flow-poh-pth-imp-icms
    ...
    Scenario Outline: 3. Lines POH
        ...
        Examples:
            ...
            | 1   | "BMS001" | "24"   | "23.32" | "3101" | "0"          | "00"      | "999"  | "49"     | "01"     | "01"     |
            | 2   | "BMS002" | "16"   | "41.25" | "3101" | "0"          | "00"      | "999"  | "49"     | "01"     | "01"     |
    ...
    Scenario Outline: 6. Import Declaration
        ...
        Examples:
            ...
            | "1"    | "1234567890" | "123ABC" | "1.62"  | "2.58"    | "4.69"    | "7.21" | "3.24"   | "Porto de Paranagua" | "PR"     |
            | "2"    | "1234567890" | "ABC123" | "3.65"  | "4.84"    | "7.21"    | "3.61" | "2.03"   | "Porto de Paranagua" | "PR"     |
    ...
    Scenario: 9. Resume
        ...
        And the value of the selected text field is "1,630.85"
        Then the user clicks the Close page action icon on the header panel
