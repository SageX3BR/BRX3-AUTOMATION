...
Feature:05020407-CST900

    Scenario: 05020407-01 Login scenario
        Given the user is logged into Sage X3 with "param:loginType" using user name "param:loginUserName" and password "param:loginPassword"

    Scenario: 05020407-02 Create PTH - ICMS CST-900
    ...
    Scenario Outline: 05020407-03 Add Lines
        ...
        Examples:
            ...
            | 1   | "BMS001" | "5"    | "100.20" | "2102" | "1"       | "900"     | "301"  | "02"     |
            | 2   | "BMS002" | "5"    | "135.00" | "2102" | "1"       | "900"     | "301"  | "02"     |
    ...
    Scenario Outline: 05020407-05 Tax Detail - Check Calculated Values
        ...
        Examples:
            ...
            | "1"    | "715.09" | "2.0000" | "14.30" |
            | "2"    | "963.44" | "2.0000" | "19.27" |

    Scenario: 05020407-06 Resume - Check Calculated Values
        ...
        And the value of the selected text field is "1,678.53"
        And the user selects the text field with X3 field name: "WE6ALLXQ_TOTICMSFCPST"
        And the value of the selected text field is "33.57"
        Then the user clicks the Close page action icon on the header panel
    ...
    Scenario: 05020407-07 Creating Purchase Return PNH
    ...
    Scenario Outline: 05020407-08 Lines
        ...
        Examples:
            ...
            | "1000" | "6202" | "1"       | "0"          | "900"     | "52"     | "50"     | "50"     | "301"  |
            | "2000" | "6202" | "1"       | "0"          | "900"     | "52"     | "50"     | "50"     | "301"  |
    ...
    Scenario Outline: 05020407-10 Tax Detail - Check Calculated Values
        Given the user selects the text field with X3 field name: "XQPTD0_CURLIG"
        When the user writes <CURLIG> to the selected text field and hits tab key
    ...
    Scenario: 05020407-11 Resume - Check Calculated Values / Transmit to Sefaz and Validation
        Given the user clicks the Close page action icon on the header panel
