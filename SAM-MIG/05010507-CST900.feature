...
Feature:05010507-CST900

    #--------------------------------------------------------------------------------
    #X3 Login Scenario
    #--------------------------------------------------------------------------------
    Scenario: 05010507-01 Login scenario
        Given the user is logged into Sage X3 with "param:loginType" using user name "param:loginUserName" and password "param:loginPassword"

    #--------------------------------------------------------------------------------
    #Validate FCP_ST fields and calculation - ICMS CST-900
    #--------------------------------------------------------------------------------
    Scenario: 05010507-02 FCP_ST fields and calculation - ICMS CST-900
    ...
    #Lines
    Scenario Outline: 05010507-03 Add Lines
    ...
    Scenario: 05010507-04 Create
        #Create
        When the user clicks the "Create" main action button on the right panel
        And a confirmation dialog appears with the message "Record has been created"

    Scenario: 05010507-05 Resume - Check Calculated Values
    ...
    Scenario: 05010507-06 Create Return
    ...
    #Lines
    Scenario Outline: 05010507-07 Add Lines
        ...
        Examples:
            ...
            | "2414" | "5"     | "0"   | "900"   | "301"  | "02"   | "01"   | "01"   |
            | "2414" | "5"     | "0"   | "900"   | "301"  | "02"   | "01"   | "01"   |

    Scenario: 05010507-08 Return Creation
        #Create
    ...
    Scenario Outline: 05010507-09 Add Lines
