...
# Header
# -------------------------------------------------------------------------
# - Test code:05020204-CST90
# - Description: Validate FCP_ST fields and calculation for CST 90 - PTH
# - Jira: NA
...
Feature:05020204-CST90

    Scenario: 05020204-01 Login scenario
        Given the user is logged into Sage X3 with "param:loginType" using user name "param:loginUserName" and password "param:loginPassword"

    Scenario: 05020204-02 Create PTH - ICMS CST-90
    ...
    #Lines
    Scenario Outline: 05020204-03 Add Lines
    ...
    Scenario: 05020204-04 Create/SEFAZ/Validation
    ...
    Scenario Outline: 05020204-05 Tax Detail - Check Calculated Values
    ...
    Scenario: 05020204-06 Resume - Check Calculated Values
