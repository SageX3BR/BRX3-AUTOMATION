...
# Header
# -------------------------------------------------------------------------
# - Test code:05020104-CST90
# - Description: Validate FCP_ST fields and calculation for CST 90 - POH
# - Jira: NA
...
Feature:05020104-CST90

    Scenario: 05020104-01 Login scenario
        Given the user is logged into Sage X3 with "param:loginType" using user name "param:loginUserName" and password "param:loginPassword"

    Scenario: 05020104-02 Create POH - ICMS CST-90
    ...
    Scenario Outline: 05020104-03 Add Lines
    ...
    Scenario: 05020104-04 Create/SEFAZ
    ...
    Scenario Outline: 05020104-05 Tax Detail - Check Calculated Values
    ...
    Scenario: 05020104-06 Resume - Check Calculated Values
        Given the user clicks the Close page action icon on the header panel
        And the user clicks the "Resume" tab selected by title
        When the user selects the text field with X3 field name: "WE3ALL2_TOTBASEFCPST"
