...
# Header
# -------------------------------------------------------------------------
# - Test code:05020403-CST70
# - Description: Validate FCP_ST fields and calculation for CST 70 - PNH
# - Jira: NA
...
Feature:05020403-CST70

    Scenario: 05020403-01 Login scenario
        Given the user is logged into Sage X3 with "param:loginType" using user name "param:loginUserName" and password "param:loginPassword"

    Scenario: 05020403-02 Create PTH - ICMS CST-70
    ...
    #Lines
    Scenario Outline: 05020403-03 Add Lines
        ...
        Examples:
            ...
            | 1   | "BMS001" | "5"    | "100.20" | "2102" | "1"       | "70"      | "999"  |
            | 2   | "BMS002" | "5"    | "135.00" | "2102" | "1"       | "70"      | "999"  |

    Scenario: 05020403-04 Create/SEFAZ/Validation
    ...
    Scenario Outline: 05020403-05 Tax Detail - Check Calculated Values
        ...
        Examples:
            ...
            | "1"    | "752.72"   | "2.0000" | "15.05" |
            | "2"    | "1,014.15" | "2.0000" | "20.28" |

    Scenario: 05020403-06 Resume - Check Calculated Values
        ...
        And the value of the selected text field is "1,766.87"
        And the user selects the text field with X3 field name: "WE6ALLXQ_TOTICMSFCPST"
        And the value of the selected text field is "35.33"
        Then the user clicks the Close page action icon on the header panel

    #-------------------------------------------------------------------------------------
    #Validate FCP_ST fields and calculation - ICMS CST-70 - PNH After PTH Created
    #-------------------------------------------------------------------------------------

    Scenario: 05020403-07 Creating Purchase Return PNH
    ...
    Scenario Outline: 05020403-08 Lines
        ...
        Examples:
            ...
            | "1000" | "6202" | "1"       | "0"          | "70"      | "51"     | "50"     | "50"     | "999"  |
            | "2000" | "6202" | "1"       | "0"          | "70"      | "51"     | "50"     | "50"     | "999"  |

    Scenario: 05020403-09 Create return
    ...
    Scenario Outline: 05020403-10 Tax Detail - Check Calculated Values
        Given the user selects the text field with X3 field name: "XQPTD0_CURLIG"
        When the user writes <CURLIG> to the selected text field and hits tab key
    ...
    Scenario: 05020403-11 Resume - Check Calculated Values / Transmit to Sefaz and Validation
        Given the user clicks the Close page action icon on the header panel
