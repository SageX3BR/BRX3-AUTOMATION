...
Feature:xq-p-flow-pih-modbcst5-cst10
    ...
    Scenario: Creation PIH
        ...
        And the user stores the value of the selected text field with the key: "DOCSUP019"
        ...
        And the user writes the stored text with key "DOCSUP019" in the selected text field and hits tab key
    ...
    Scenario Outline: Add Lines
        ...
        Examples:
            ...
            | 1   | "BMS001" | "5"    | "17.58" | "2101" | "5"       | "0"          | "10"      | "999"  |
            | 2   | "BMS001" | "7"    | "19.85" | "2101" | "5"       | "0"          | "10"      | "999"  |
    ...
    Scenario Outline: Tax Detail - Check Calculated Values
        ...
        And the user selects the text field with X3 field name: "WE3PTDXQ_MDBCICMSST"
