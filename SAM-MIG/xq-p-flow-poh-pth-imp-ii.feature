...
# Header
# -------------------------------------------------------------------------
# - Test code: xq-p-flow-poh-pth-imp-ii
...
Feature: xq-p-flow-poh-pth-imp-ii
    ...
    Scenario Outline: 3. Lines POH
        ...
        Examples:
            ...
            | 1   | "BMS001" | "13"   | "13.65" | "3101" | "0"          | "00"      | "999"  | "49"     | "01"     | "01"     |
            | 2   | "BMS002" | "15"   | "4.25"  | "3101" | "0"          | "00"      | "999"  | "49"     | "01"     | "01"     |
    ...
    Scenario Outline: 6. Import Declaration
        ...
        Examples:
            ...
            | "1"    | "1234567890" | "123ABC" | "1.03"  | "2.12"    | "0.36"    | "1.47" | "6.25"   | "Porto de Paranagua" | "PR"     |
            | "2"    | "1234567890" | "ABC123" | "0.69"  | "4.25"    | "1.26"    | "0.41" | "1.32"   | "Porto de Paranagua" | "PR"     |
    ...
    Scenario: 9. Resume
        ...
        And the value of the selected text field is "279.40"
        Then the user clicks the Close page action icon on the header panel
