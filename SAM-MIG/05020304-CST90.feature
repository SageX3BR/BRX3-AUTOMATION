...
Feature:05020304-CST90

    Scenario: 05020304-01 Login scenario
        Given the user is logged into Sage X3 with "param:loginType" using user name "param:loginUserName" and password "param:loginPassword"

    Scenario: 05020304-02 Create PIH - ICMS CST-90
        ...
        And the user stores the value of the selected text field with the key: "DOCSUP012"
        ...
        And the user writes the stored text with key "DOCSUP012" in the selected text field and hits tab key
    ...
    Scenario Outline: 05020304-03 Add Lines
        ...
        Examples:
            ...
            | "BMS001" | "15"   | "17.58" | "1102" | "1"       | "90"      | "999"  |
            | "BMS002" | "12"   | "19.85" | "1102" | "1"       | "90"      | "999"  |
    ...
    Scenario Outline: 05020304-05 Tax Detail - Check Calculated Values
    ...
    Scenario: 05020304-06 Resume - Check Calculated Values
