...
# Header
# -------------------------------------------------------------------------
# - Test code: xq-p-flow-poh-pih-imp-txac
# - Description: Import receipt create via picking a order with
# Add Import exp. to acess. exp. in the NF-e Summary
# - Jira: NA
# - Legislation: BRA
...
Feature: xq-p-flow-poh-pih-imp-txac
    ...
    Scenario Outline: 12. Lines POH
        ...
        Examples:
            ...
            | 1   | "BMS001" | "32"   | "32.69" | "3101" | "0"          | "00"      | "999"  | "49"     | "01"     | "01"     |
            | 2   | "BMS002" | "15"   | "42.32" | "3101" | "0"          | "00"      | "999"  | "49"     | "01"     | "01"     |
    ...
    Scenario: 15. Header PIH
        ...
        And the user stores the value of the selected text field with the key: "DOCSUP048"
        Then the user clicks the Close page action icon on the header panel
    ...
    Scenario: 17. Management
        ...
        And the user writes the stored text with key "DOCSUP048" in the selected text field and hits tab key
    ...
    Scenario Outline: 19. Import Declaration
        ...
        Examples:
            ...
            | "1"    | "1234567890" | "123ABC" | "1.62"  | "2.02"    | "0.32"    | "5.21" | "6.17"   | "Porto de Paranagua" | "PR"     |
            | "2"    | "1234567890" | "ABC123" | "0.95"  | "1.58"    | "6.62"    | "7.12" | "8.08"   | "Porto de Paranagua" | "PR"     |
    ...
    Scenario: 9. Resume
        ...
        And the user selects the text field with X3 field name: "WE8ALLXQ_TTDESPACES"
        And the value of the selected text field is "36.09"
        Then the user clicks the Close page action icon on the header panel
