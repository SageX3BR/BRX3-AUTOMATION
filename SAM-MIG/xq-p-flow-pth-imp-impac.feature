...
# Header
# -------------------------------------------------------------------------
# - Test code: xq-p-flow-pth-imp-impac
# - Description: Import receipt with Add Import exp. to acess. exp. in the NF-e Summary
# - Jira: NA
# - Legislation: BRA
...
Feature: xq-p-flow-pth-imp-impac
    ...
    Scenario Outline: 6. Import Declaration
        ...
        Examples:
            ...
            | "1"    | "1234567890" | "123ABC" | "1.36"  | "2.31"    | "1.38"    | "7.24" | "4.95"   | "Porto de Paranagua" | "PR"     |
            | "2"    | "1234567890" | "ABC123" | "2.54"  | "4.36"    | "3.64"    | "4.21" | "7.09"   | "Porto de Paranagua" | "PR"     |
