...
Feature: xq-p-flow-poh-pih-ef-02
    ...
    Scenario Outline: 12. Lines POH
        ...
        Examples:
            ...
            | 1   | "BMS001" | "6"    | "21.69" | "3101" | "0"          | "00"      | "999"  | "49"     | "01"     | "01"     |
            | 2   | "BMS002" | "9"    | "4.69"  | "3101" | "0"          | "00"      | "999"  | "49"     | "01"     | "01"     |

    Scenario: 13. Invoice Elements
        ...
        And the user adds the text "11.11" in selected cell and hits enter key
        And the user selects the fixed cell with X3 field name: "WE3ALL3_INVDTAAMT" and row number: (2)
        And the user adds the text "6.54" in selected cell and hits enter key
        And the user selects the fixed cell with X3 field name: "WE3ALL3_INVDTAAMT" and row number: (4)
        And the user adds the text "3.21" in selected cell and hits enter key
    ...
    Scenario: 15. Header PIH
        ...
        And the user stores the value of the selected text field with the key: "DOCSUP043"
        Then the user clicks the Close page action icon on the header panel
    ...
    Scenario: 17. Management
        ...
        And the user writes the stored text with key "DOCSUP043" in the selected text field and hits tab key
    ...
    Scenario: 22. Check Values Invoice Elements
