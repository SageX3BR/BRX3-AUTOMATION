...
# Header
# -------------------------------------------------------------------------
# - Test code: xq-p-flow-pth-imp-imptx
# - Description: Import receipt with Sum import taxes to inv. total in the NF-e Summary
# - Jira: NA
# - Legislation: BRA
...
Feature: xq-p-flow-pth-imp-imptx
    ...
    Scenario Outline: 6. Import Declaration
        ...
        Examples:
            ...
            | "1"    | "1234567890" | "123ABC" | "2.36"  | "5.25"    | "4.95"    | "7.62" | "3.24"   | "Porto de Paranagua" | "PR"     |
            | "2"    | "1234567890" | "ABC123" | "1.65"  | "7.45"    | "1.24"    | "0.36" | "5.78"   | "Porto de Paranagua" | "PR"     |
    ...
    Scenario: 9. Resume
        ...
        And the value of the selected text field is "2,220.40"
