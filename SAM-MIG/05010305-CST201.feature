...
Feature:05010305-CST201

    #--------------------------------------------------------------------------------
    #X3 Login Scenario
    #--------------------------------------------------------------------------------
    Scenario: 05010305-01 Login scenario
        Given the user is logged into Sage X3 with "param:loginType" using user name "param:loginUserName" and password "param:loginPassword"

    #--------------------------------------------------------------------------------
    #Validate FCP_ST fields and calculation - ICMS CST-201
    #--------------------------------------------------------------------------------
    Scenario: 05010305-02 FCP_ST fields and calculation - ICMS CST-201
    ...
    #Lines
    Scenario Outline: 05010305-03 Add Lines
        ...
        Examples:
            ...
            | 1   | "BMS001" | "14" | "98.54" | "201"     | "SP099090" | "301"  |
            | 2   | "BMS002" | "16" | "98.52" | "201"     | "SP099090" | "301"  |

    Scenario: 05010305-04 Create
        #Create
        When the user clicks the "Create" main action button on the right panel
        And a confirmation dialog appears with the message "Record has been created"

    Scenario: 05010305-05 Resume - Check Calculated Values
    ...
    Scenario: 05010305-06 Create Invoice - SEFAZ - Validation
