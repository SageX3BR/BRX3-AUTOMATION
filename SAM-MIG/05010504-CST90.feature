...
Feature:05010504-CST90

    #--------------------------------------------------------------------------------
    #X3 Login Scenario
    #--------------------------------------------------------------------------------
    Scenario: 05010504-01 Login scenario
        Given the user is logged into Sage X3 with "param:loginType" using user name "param:loginUserName" and password "param:loginPassword"

    #--------------------------------------------------------------------------------
    #Validate FCP_ST fields and calculation - ICMS CST-90
    #--------------------------------------------------------------------------------
    Scenario: 05010504-02 FCP_ST fields and calculation - ICMS CST-90
    ...
    #Lines
    Scenario Outline: 05010504-03 Add Lines
        ...
        Examples:
            ...
            | 1   | "BMS001" | "14" | "98.54" | "90"      | "SP099090" |
            | 2   | "BMS002" | "16" | "98.52" | "90"      | "SP099090" |

    Scenario: 05010504-04 Create
        #Create
    ...
    Scenario: 05010504-06 Create Return
    ...
    #Lines
    Scenario Outline: 05010504-07 Add Lines
        ...
        Examples:
            ...
            | "2414" | "5"     | "0"   | "90"    | "999"  | "01"   | "01"   | "01"   |
            | "2414" | "5"     | "0"   | "90"    | "999"  | "01"   | "01"   | "01"   |

    Scenario: 05010504-08 Return Creation
        #Create
    ...
    Scenario Outline: 05010504-09 Add Lines
