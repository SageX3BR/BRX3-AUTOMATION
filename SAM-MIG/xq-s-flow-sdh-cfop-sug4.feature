...
# Header
# -------------------------------------------------------------------------
# - Test code: xq-s-flow-sdh-cfop-sug4
# - Description: Sugerir CFOP na segunda linha - SDH
# - Jira: NA
...
Feature: xq-s-flow-sdh-cfop-sug4
    ...
    Scenario Outline: Add Line With CFOP
        ...
        Examples:
            ...
            | 1   | "BMS001" | "21" | "24.95" | "5101" |

    Scenario Outline: Add Line Without CFOP
        Given the user selects editable table row number: <LIN>
        And the user selects last fixed cell with X3 field name: "WK4ALL1_ITMREF"
        And the user adds the text <ITMREF> in selected cell
        And the user selects last editable cell with X3 field name: "WK4ALL1_QTY"
