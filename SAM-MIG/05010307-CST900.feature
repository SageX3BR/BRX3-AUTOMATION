...
Feature:05010307-CST900

    #--------------------------------------------------------------------------------
    #X3 Login Scenario
    #--------------------------------------------------------------------------------
    Scenario: 05010307-01 Login scenario
        Given the user is logged into Sage X3 with "param:loginType" using user name "param:loginUserName" and password "param:loginPassword"

    #--------------------------------------------------------------------------------
    #Validate FCP_ST fields and calculation - ICMS CST-900
    #--------------------------------------------------------------------------------
    Scenario: 05010307-02 FCP_ST fields and calculation - ICMS CST-900
    ...
    #Lines
    Scenario Outline: 05010307-03 Add Lines
        ...
        Examples:
            ...
            | 1   | "BMS001" | "14" | "98.54" | "900"     | "SP099090" | "301"  |
            | 2   | "BMS002" | "16" | "98.52" | "900"     | "SP099090" | "301"  |

    Scenario: 05010307-04 Create
        #Create
    ...
    Scenario: 05010307-06 Create Invoice - SEFAZ - Validation
