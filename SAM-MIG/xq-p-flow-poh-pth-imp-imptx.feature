...
# Header
# -------------------------------------------------------------------------
# - Test code: xq-p-flow-poh-pth-imp-imptx
...
Feature: xq-p-flow-poh-pth-imp-imptx
    ...
    Scenario Outline: 3. Lines POH
        ...
        Examples:
            ...
            | 1   | "BMS001" | "21"   | "32.26" | "3101" | "0"          | "00"      | "999"  | "49"     | "01"     | "01"     |
            | 2   | "BMS002" | "19"   | "21.32" | "3101" | "0"          | "00"      | "999"  | "49"     | "01"     | "01"     |
    ...
    Scenario Outline: 6. Import Declaration
        ...
        Examples:
            ...
            | "1"    | "1234567890" | "123ABC" | "0.36"  | "1.25"    | "4.16"    | "1.36" | "2.94"   | "Porto de Paranagua" | "PR"     |
            | "2"    | "1234567890" | "ABC123" | "1.02"  | "4.31"    | "5.02"    | "3.01" | "0.36"   | "Porto de Paranagua" | "PR"     |
    ...
    Scenario: 9. Resume
        ...
        And the user selects the text field with X3 field name: "WE6ALLXQ_TTNFE"
        And the value of the selected text field is "1,216.00"
        Then the user clicks the Close page action icon on the header panel
