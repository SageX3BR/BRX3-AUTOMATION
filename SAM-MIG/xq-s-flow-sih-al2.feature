...
# Header
# -------------------------------------------------------------------------
# - Test code: xq-s-flow-sih-al2
# - Description: SIH Average Load Same Client2
# - Jira: NA
...
# SCENARIO 1: Creation Sales Invoice with Average load and the same client - Second product
#
# PREREQUISITES:
...
Feature: xq-s-flow-sih-al2
    ...
    Scenario: Check Calculated Values
        ...
        And the value of the selected cell is "88.19"
