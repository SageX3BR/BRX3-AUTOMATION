...
Feature: xq-p-flow-pth-pih
    ...
    Scenario: 6. Header PIH
        ...
        And the user stores the value of the selected text field with the key: "DOCSUP049"
        Then the user clicks the Close page action icon on the header panel
    ...
    Scenario: 8. Management
        ...
        And the user writes the stored text with key "DOCSUP049" in the selected text field and hits tab key
