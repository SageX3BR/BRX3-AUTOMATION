...
# Header
# -------------------------------------------------------------------------
# - Test code:05020405-CST201
# - Description: Validate FCP_ST fields and calculation for CST 201 - PNH
# - Jira: NA
...
Feature:05020405-CST201

    Scenario: 05020405-01 Login scenario
        Given the user is logged into Sage X3 with "param:loginType" using user name "param:loginUserName" and password "param:loginPassword"

    Scenario: 05020405-02 Create PTH - ICMS CST-201
    ...
    Scenario Outline: 05020405-03 Add Lines
        ...
        Examples:
            ...
            | 1   | "BMS001" | "10"   | "78.50" | "2102" | "1"       | "201"     | "301"  | "02"     |
            | 2   | "BMS002" | "10"   | "85.60" | "2102" | "1"       | "201"     | "301"  | "02"     |

    Scenario: 05020405-04 Create/SEFAZ/Validation
    ...
    Scenario Outline: 05020405-05 Tax Detail - Check Calculated Values
        ...
        Examples:
            ...
            | "1"    | "1,179.41" | "2.0000" | "23.59" |
            | "2"    | "1,286.09" | "2.0000" | "25.72" |

    Scenario: 05020405-06 Resume - Check Calculated Values
        ...
        And the value of the selected text field is "2,465.50"
        And the user selects the text field with X3 field name: "WE6ALLXQ_TOTICMSFCPST"
        And the value of the selected text field is "49.31"
        Then the user clicks the Close page action icon on the header panel

    #-------------------------------------------------------------------------------------
    #Validate FCP_ST fields and calculation - ICMS CST-201 - PNH After PTH Created
    #-------------------------------------------------------------------------------------

    Scenario: 05020405-07 Creating Purchase Return PNH
    ...
    Scenario Outline: 05020405-08 Lines
        ...
        Examples:
            ...
            | "1000" | "6202" | "1"       | "0"          | "201"     | "52"     | "50"     | "50"     | "301"  |
            | "2000" | "6202" | "1"       | "0"          | "201"     | "52"     | "50"     | "50"     | "301"  |

    Scenario: 05020405-09 Create return
    ...
    Scenario Outline: 05020405-10 Tax Detail - Check Calculated Values
        Given the user selects the text field with X3 field name: "XQPTD0_CURLIG"
        When the user writes <CURLIG> to the selected text field and hits tab key
    ...
    Scenario: 05020405-11 Resume - Check Calculated Values / Transmit to Sefaz and Validation
        Given the user clicks the Close page action icon on the header panel
