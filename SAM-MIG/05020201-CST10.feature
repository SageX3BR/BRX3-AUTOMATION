...
# Header
# -------------------------------------------------------------------------
# - Test code:05020201-CST10
# - Description: Validate FCP_ST fields and calculation for CST 10 - PTH
# - Jira: NA
...
Feature:05020201-CST10

    Scenario: 05020201-01 Login scenario
        Given the user is logged into Sage X3 with "param:loginType" using user name "param:loginUserName" and password "param:loginPassword"

    Scenario: 05020201-02 Create PTH - ICMS CST-10
    ...
    #Lines
    Scenario Outline: 05020201-03 Add Lines
    ...
    Scenario: 05020201-04 Create/SEFAZ/Validation
    ...
    Scenario Outline: 05020201-05 Tax Detail - Check Calculated Values
    ...
    Scenario: 05020201-06 Resume - Check Calculated Values
