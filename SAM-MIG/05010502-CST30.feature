...
Feature:05010502-CST30

    #--------------------------------------------------------------------------------
    #X3 Login Scenario
    #--------------------------------------------------------------------------------
    Scenario: 05010502-01 Login scenario
        Given the user is logged into Sage X3 with "param:loginType" using user name "param:loginUserName" and password "param:loginPassword"

    #--------------------------------------------------------------------------------
    #Validate FCP_ST fields and calculation - ICMS CST-30
    #--------------------------------------------------------------------------------
    Scenario: 05010502-02 FCP_ST fields and calculation - ICMS CST-30
    ...
    #Lines
    Scenario Outline: 05010502-03 Add Lines
        ...
        Examples:
            ...
            | 1   | "BMS001" | "14" | "98.54" | "30"      | "SP099090" |
            | 2   | "BMS002" | "16" | "98.52" | "30"      | "SP099090" |

    Scenario: 05010502-04 Create
        #Create
        When the user clicks the "Create" main action button on the right panel
        And a confirmation dialog appears with the message "Record has been created"

    Scenario: 05010502-05 Resume - Check Calculated Values
    ...
    Scenario: 05010502-06 Create Return
    ...
    #Lines
    Scenario Outline: 05010502-07 Add Lines
        ...
        Examples:
            ...
            | "2414" | "5"     | "0"   | "30"    | "999"  | "01"   | "01"   | "01"   |
            | "2414" | "5"     | "0"   | "30"    | "999"  | "01"   | "01"   | "01"   |

    Scenario: 05010502-08 Return Creation
        #Create
    ...
    Scenario Outline: 05010502-09 Add Lines
    ...
    Scenario: 05010502-10 Resume - Check Calculated Values
