...
# Header
# -------------------------------------------------------------------------
# - Test code: xq-p-flow-poh-pih-imp-all2
...
Feature: xq-p-flow-poh-pih-imp-all2
    ...
    Scenario: 2. Header POH
        ...
        And the user writes "135" to the selected text field and hits tab key
    ...
    Scenario Outline: 3. Lines POH
        ...
        Examples:
            ...
            | 1   | "BMS001" | "21"   | "23.65" | "3101" | "0"          | "00"      | "999"  | "49"     | "01"     | "01"     |
            | 2   | "BMS002" | "32"   | "31.59" | "3101" | "0"          | "00"      | "999"  | "49"     | "01"     | "01"     |
    ...
    Scenario: 5. Header PIH
        ...
        And the user stores the value of the selected text field with the key: "DOCSUP005"
        Then the user clicks the Close page action icon on the header panel
    ...
    Scenario: 7. Management
        ...
        And the user writes the stored text with key "DOCSUP005" in the selected text field and hits tab key
    ...
    Scenario Outline: 9. Import Declaration
        ...
        Examples:
            ...
            | "1"    | "1234567890" | "123ABC" | "1.25"  | "2.36"    | "5.62"    | "4.61" | "3.02"   | "Porto de Paranagua" | "PR"     |
            | "2"    | "1234567890" | "ABC123" | "3.25"  | "4.25"    | "1.36"    | "6.21" | "6.32"   | "Porto de Paranagua" | "PR"     |
    ...
    Scenario: 12. Resume
        ...
        And the value of the selected text field is "86.67"
        Then the user clicks the Close page action icon on the header panel
