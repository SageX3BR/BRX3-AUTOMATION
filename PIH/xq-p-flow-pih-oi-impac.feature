...
# Header
# -------------------------------------------------------------------------
# - Test code: xq-p-flow-pih-oi-impac
# - Description: Open Items for Import invoice with the checkbox
# "Add Import exp. to acess. exp." from the Fiscal operation selected
# - Jira: NA
# - Legislation: BRA
...
Feature: xq-p-flow-pih-oi-impac
    ...
    Scenario: 1. Header
        ...
        And the user stores the value of the selected text field with the key: "DOCSUP035"
    ...
    Scenario: 3. Management
        ...
        And the user writes the stored text with key "DOCSUP035" in the selected text field and hits tab key
    ...
    Scenario Outline: 4. Lines
        ...
        Examples:
            ...
            | 1   | "BMS001" | "32"   | "25.03" | "3101" | "0"          | "00"      | "999"  | "49"     | "01"     | "01"     |
            | 2   | "BMS002" | "24"   | "64.15" | "3101" | "0"          | "00"      | "999"  | "49"     | "01"     | "01"     |
    ...
    Scenario Outline: 6. Import Declaration
        ...
        Examples:
            ...
            | "1"    | "1234567890" | "123ABC" | "12.32" | "4.12"    | "5.95"    | "7.23" | "8.45"   | "Porto de Paranagua" | "PR"     |
            | "2"    | "1234567890" | "ABC123" | "8.25"  | "4.36"    | "6.84"    | "9.23" | "5.24"   | "Porto de Paranagua" | "PR"     |
    ...
    Scenario: 9. Open Items
        ...
        And the value of the selected cell is "2,655.06"
