...
Feature: xq-p-flow-pih-oi-insur-02
    ...
    Scenario: 2. Header
        ...
        And the user stores the value of the selected text field with the key: "DOCSUP038"
    ...
    Scenario: 11. Management
        ...
        And the user writes the stored text with key "DOCSUP038" in the selected text field and hits tab key
