...
Feature: xq-p-flow-pih-oi-disc-01
    ...
    Scenario: 2. Header
        ...
        And the user stores the value of the selected text field with the key: "DOCSUP028"
    ...
    Scenario: 4. Management
        ...
        And the user writes the stored text with key "DOCSUP028" in the selected text field and hits tab key
