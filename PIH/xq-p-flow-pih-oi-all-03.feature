...
Feature: xq-p-flow-pih-oi-all-03
    ...
    Scenario: 2. Header
        ...
        And the user stores the value of the selected text field with the key: "DOCSUP027"
    ...
    Scenario: 21. Management
        ...
        And the user writes the stored text with key "DOCSUP027" in the selected text field and hits tab key
