...
# Header
# -------------------------------------------------------------------------
# - Test code:xq-p-flow-pih-oi-icms
...
Feature: xq-p-flow-pih-oi-icms
    ...
    Scenario: 1. Header
        ...
        And the user stores the value of the selected text field with the key: "DOCSUP033"
    ...
    Scenario: 3. Management
        ...
        And the user writes the stored text with key "DOCSUP033" in the selected text field and hits tab key
    ...
    Scenario Outline: 4. Lines
        ...
        Examples:
            ...
            | 1   | "BMS001" | "45"   | "32.96"  | "3101" | "0"          | "00"      | "999"  | "49"     | "01"     | "01"     |
            | 2   | "BMS002" | "26"   | "105.45" | "3101" | "0"          | "00"      | "999"  | "49"     | "01"     | "01"     |
    ...
    Scenario Outline: 6. Import Declaration
        ...
        Examples:
            ...
            | "1"    | "1234567890" | "123ABC" | "12.69" | "12.36"   | "9.45"    | "13.26" | "8.25"   | "Porto de Paranagua" | "PR"     |
            | "2"    | "1234567890" | "ABC123" | "9.99"  | "4.52"    | "2.36"    | "4.75"  | "25.36"  | "Porto de Paranagua" | "PR"     |
    ...
    Scenario: 9. Open Items
        ...
        And the value of the selected cell is "5,643.03"
