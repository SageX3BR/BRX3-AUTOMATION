...
Feature:  xq-s-flow-sih-pick-sdh-01
    ...
    Scenario: Create document
        ...
        And the user stores the value of the selected text field with the key: "SDH_NUM02"
    ...
    Scenario: Left List
        ...
        And the user adds the stored text with key "SDH_NUM02" in selected cell and hits enter key
        And the user selects cell that matches exact with the stored text with the key: "SDH_NUM02" and column header: "Delivery"
        And the user clicks on the selected cell
