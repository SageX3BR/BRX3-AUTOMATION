...
# Header
# -------------------------------------------------------------------------
# - Test code:xq-p-flow-pih-FCPST-70
...
Feature:xq-p-flow-pih-fcpst-70

    Scenario: 1.Login scenario
        Given the user is logged into Sage X3 with "param:loginType" using user name "param:loginUserName" and password "param:loginPassword"

    Scenario: 2. Create PIH - ICMS CST-70
    ...
    Scenario Outline: Add Lines
        ...
        Examples:
            ...
            | 1   | "BMS001" | "12"   | "17.58" | "1102" | "1"       | "0"          | "70"      | "999"  | "01"     | "01"     | "01"     |
            | 2   | "BMS002" | "15"   | "19.85" | "1102" | "1"       | "0"          | "70"      | "999"  | "01"     | "01"     | "01"     |
