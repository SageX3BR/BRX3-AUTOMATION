...
Feature:xq-p-flow-pih-fcpst-10-30-70-90
    ...
    Scenario Outline: Tax Detail - Check Calculated Values
        ...
        Examples:
            ...
            | "3"    | "246.12" | "2.0000" | "4.92"  |
            | "4"    | "333.48" | "2.0000" | "6.67"  |
            | "5"    | "295.34" | "2.0000" | "5.91"  |
            | "6"    | "416.85" | "2.0000" | "8.34"  |
            | "7"    | "350.72" | "2.0000" | "7.01"  |
            | "8"    | "316.81" | "2.0000" | "6.34"  |
    ...
    Scenario: Resume - Check Calculated Values
        ...
        And the value of the selected text field is "2,276.91"
        And the user selects the text field with X3 field name: "XQPIH2_TOTICMSFCPST"
        And the value of the selected text field is "45.54"
