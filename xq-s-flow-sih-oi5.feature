...
# Header
# -------------------------------------------------------------------------
# - Test code: xq-s-flow-sih-oi5
# - Description: Open Items for Sales National invoice without incidences - Conjugated
# - Jira: NA
...
Feature: xq-s-flow-sih-oi5
    ...
    Scenario: 2. Create a Invoice
        ...
        And the user writes "103" to the selected text field and hits tab key
    ...
    Scenario Outline: Add Lines
        ...
        Examples:
            | LIN | ITMREF   | QTY  | GROPRI  | XQCFOP | XQOICMS | XQCSTICMS | XQCENQ | XQSTISS | XQEXISS | VACITM1 |
            | 1   | "BMS001" | "12" | "15.36" | "6101" | "0"     | "00"      | "999"  | ""      | ""      | ""      |
            | 2   | "SER001" | "3"  | "62.36" | "6101" | ""      | ""        | ""     | "1"     | "1"     | "BRL"   |
    ...
    Scenario: Open Items
        ...
        And the value of the selected cell is "322.7506"
