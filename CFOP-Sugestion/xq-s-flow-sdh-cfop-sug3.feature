...
# Header
# -------------------------------------------------------------------------
# - Test code: xq-s-flow-sdh-cfop-sug3
# - Description: Sugerir CFOP na primeira linha - SDH
# - Jira: NA
...
Feature: xq-s-flow-sdh-cfop-sug3
    ...
    Scenario: 3. Check the CFOP
        ...
        And the user selects row that has the text "BMS001" in column with X3 field name: "WK4ALL1_ITMREF"
