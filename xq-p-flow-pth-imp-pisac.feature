...
# Header
# -------------------------------------------------------------------------
# - Test code: xq-p-flow-pth-imp-pisac
# - Description: Import receipt with Add PIS/COFINS to acess. exp. in the NF-e Summary
# - Jira: NA
# - Legislation: BRA
...
Feature: xq-p-flow-pth-imp-pisac
    ...
    Scenario Outline: 4. Add Lines
        ...
        Examples:
            ...
            | 1   | "BMS001" | "16"   | "21.22" | "3101" | "0"          | "00"      | "999"  | "49"     | "01"     | "01"     |
            | 2   | "BMS002" | "25"   | "4.65"  | "3101" | "0"          | "00"      | "999"  | "49"     | "01"     | "01"     |
    ...
    Scenario Outline: 6. Import Declaration
        ...
        Examples:
            ...
            | "1"    | "1234567890" | "123ABC" | "1.36"  | "2.41"    | "8.21"    | "2.95" | "7.23"   | "Porto de Paranagua" | "PR"     |
            | "2"    | "1234567890" | "ABC123" | "2.52"  | "3.84"    | "5.02"    | "6.31" | "4.69"   | "Porto de Paranagua" | "PR"     |
    ...
    Scenario: 9. Resume
        ...
        And the value of the selected text field is "16.6500"
