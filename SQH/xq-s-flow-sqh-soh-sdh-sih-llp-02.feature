...
Feature: xq-s-flow-sqh-soh-sdh-sih-llp-02
    ...
    Scenario: 9. Left List
        ...
        And the user adds the stored text with key "SDH_NUM09" in selected cell and hits enter key
        And the user selects cell that matches exact with the stored text with the key: "SDH_NUM09" and column header: "Delivery"
        And the user clicks on the selected cell
        And an alert box appears
        And the user clicks the "Yes" opinion in the alert box
