...
Feature:05010204-CST90

    #--------------------------------------------------------------------------------
    #X3 Login Scenario
    #--------------------------------------------------------------------------------
    Scenario: 05010204-01 Login scenario
        Given the user is logged into Sage X3 with "param:loginType" using user name "param:loginUserName" and password "param:loginPassword"

    #--------------------------------------------------------------------------------
    #Validate FCP_ST fields and calculation - ICMS CST-90
    #--------------------------------------------------------------------------------
    Scenario: 05010204-02 FCP_ST fields and calculation - ICMS CST-90
    ...
    #Lines
    Scenario Outline: 05010204-03 Add Lines
    ...
    Scenario: 05010204-04 Create
        #Create
        When the user clicks the "Create" main action button on the right panel
        And a confirmation dialog appears with the message "Record has been created"

    Scenario: 05010204-05 Resume - Check Calculated Values
    ...
    Scenario: 05010204-06 Create Delivery
    ...
    Scenario: 05010204-07 Create Invoice - SEFAZ - Validation
        Given the user selects the data table in the popup
