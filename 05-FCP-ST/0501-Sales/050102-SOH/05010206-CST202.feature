...
Feature:05010206-CST202

    #--------------------------------------------------------------------------------
    #X3 Login Scenario
    #--------------------------------------------------------------------------------
    Scenario: 05010206-01 Login scenario
        Given the user is logged into Sage X3 with "param:loginType" using user name "param:loginUserName" and password "param:loginPassword"

    #--------------------------------------------------------------------------------
    #Validate FCP_ST fields and calculation - ICMS CST-202
    #--------------------------------------------------------------------------------
    Scenario: 05010206-02 FCP_ST fields and calculation - ICMS CST-202
    ...
    #Lines
    Scenario Outline: 05010206-03 Add Lines
        ...
        Examples:
            ...
            | 1   | "BMS001" | "BR001" | "14" | "98.54" | "202"     | "301"  |
            | 2   | "BMS002" | "BR001" | "16" | "98.52" | "202"     | "301"  |

    Scenario: 05010206-04 Create
        #Create
        When the user clicks the "Create" main action button on the right panel
        And a confirmation dialog appears with the message "Record has been created"

    Scenario: 05010206-05 Resume - Check Calculated Values
    ...
    Scenario: 05010206-06 Create Delivery
    ...
    Scenario: 05010206-07 Create Invoice - SEFAZ - Validation
        Given the user selects the data table in the popup
