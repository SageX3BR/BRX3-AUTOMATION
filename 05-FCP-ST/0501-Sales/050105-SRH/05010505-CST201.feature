...
Feature:05010505-CST201

    #--------------------------------------------------------------------------------
    #X3 Login Scenario
    #--------------------------------------------------------------------------------
    Scenario: 05010505-01 Login scenario
        Given the user is logged into Sage X3 with "param:loginType" using user name "param:loginUserName" and password "param:loginPassword"

    #--------------------------------------------------------------------------------
    #Validate FCP_ST fields and calculation - ICMS CST-201
    #--------------------------------------------------------------------------------
    Scenario: 05010505-02 FCP_ST fields and calculation - ICMS CST-201
    ...
    #Lines
    Scenario Outline: 05010505-03 Add Lines
        ...
        Examples:
            ...
            | 1   | "BMS001" | "14" | "98.54" | "201"     | "301"  |
            | 2   | "BMS002" | "16" | "98.52" | "201"     | "301"  |

    Scenario: 05010505-04 Create
        #Create
        When the user clicks the "Create" main action button on the right panel
        And a confirmation dialog appears with the message "Record has been created"

    Scenario: 05010505-05 Resume - Check Calculated Values
    ...
    Scenario: 05010505-06 Create Return
    ...
    #Lines
    Scenario Outline: 05010505-07 Add Lines
        ...
        Examples:
            ...
            | "2414" | "5"     | "0"   | "201"   | "301"  | "02"   | "01"   | "01"   |
            | "2414" | "5"     | "0"   | "201"   | "301"  | "02"   | "01"   | "01"   |

    Scenario: 05010505-08 Return Creation
        #Create
    ...
    Scenario Outline: 05010505-09 Add Lines
    ...
    Scenario: 05010505-10 Resume - Check Calculated Values
