...
Feature:05020302-CST30

    Scenario: 05020302-01 Login scenario
        Given the user is logged into Sage X3 with "param:loginType" using user name "param:loginUserName" and password "param:loginPassword"

    Scenario: 05020302-02 Create PIH - ICMS CST-30
        ...
        And the user stores the value of the selected text field with the key: "DOCSUP010"
        ...
        And the user writes the stored text with key "DOCSUP010" in the selected text field and hits tab key


    Scenario Outline: 05020302-03 Add Lines
        ...
        Examples:
            ...
            | 1   | "BMS001" | "10"   | "17.58" | "1102" | "1"       | "30"      | "999"  |
            | 2   | "BMS002" | "12"   | "19.85" | "1102" | "1"       | "30"      | "999"  |

    Scenario: 05020302-04 Create/SEFAZ/Validation
    ...
    Scenario Outline: 05020302-05 Tax Detail - Check Calculated Values
        ...
        Examples:
            ...
            | "1"    | "246.12" | "2.0000" | "4.92"  |
            | "2"    | "333.48" | "2.0000" | "6.67"  |

    Scenario: 05020302-06 Resume - Check Calculated Values
        ...
        And the value of the selected text field is "579.60"
        And the user selects the text field with X3 field name: "XQPIH2_TOTICMSFCPST"
        And the value of the selected text field is "11.59"

    Scenario: 05020302-07 Logout
