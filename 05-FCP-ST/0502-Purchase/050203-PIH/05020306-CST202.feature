...
# Header
# -------------------------------------------------------------------------
# - Test code:05020306-CST202
# - Description: Validate FCP_ST fields and calculation for CST 202 - PIH
# - Jira: NA
...
Feature:05020306-CST202

    Scenario: 05020306-01 Login scenario
        Given the user is logged into Sage X3 with "param:loginType" using user name "param:loginUserName" and password "param:loginPassword"

    Scenario: 05020306-02 Create PIH - ICMS CST-202
    ...
    Scenario Outline: 05020306-03 Add Lines
        ...
        Examples:
            ...
            | 1   | "BMS001" | "9"    | "17.58" | "1102" | "1"       | "0"          | "202"     | "301"  | "02"     | "01"     | "01"     |
            | 2   | "BMS002" | "8"    | "19.85" | "1102" | "1"       | "0"          | "202"     | "301"  | "02"     | "01"     | "01"     |

    Scenario: 05020306-04 Create/SEFAZ/Validation
        #Control Tab
    ...
    Scenario Outline: 05020306-05 Tax Detail - Check Calculated Values
    ...
    Scenario: 05020306-06 Resume - Check Calculated Values
