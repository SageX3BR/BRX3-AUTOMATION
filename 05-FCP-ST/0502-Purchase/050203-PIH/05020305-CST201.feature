...
Feature:05020305-CST201

    Scenario: 05020305-01 Login scenario
        Given the user is logged into Sage X3 with "param:loginType" using user name "param:loginUserName" and password "param:loginPassword"

    Scenario: 05020305-02 Create PIH - ICMS CST-201
        ...
        And the user stores the value of the selected text field with the key: "DOCSUP013"
        ...
        And the user writes the stored text with key "DOCSUP013" in the selected text field and hits tab key
    ...
    Scenario Outline: 05020305-05 Tax Detail - Check Calculated Values
    ...
    Scenario: 05020305-06 Resume - Check Calculated Values
