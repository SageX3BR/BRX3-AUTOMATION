...
# Header
# -------------------------------------------------------------------------
# - Test code: xq-s-flow-sdh-pisOutr-cofinsOutr
...
# -------------------------------------------------------------------------
#
# Set a RTAX with PIS/COFINS (per rate) using CST 49
# Set a RTAX with PIS/COFINS (per amount) using CST 49
# Set VTAX for these RTAX using CFOP variation as parameters
#
# ###########################################################################

Feature: xq-s-flow-sdh-pisOutr-cofinsOutr
    ...
    Scenario Outline: Add Lines
        ...
        Examples:
            ...
            | 1   | "BMS001" | "10" | "12.69" | "6101" | "3"       | "0"     | "00"      |
            | 2   | "BMS001" | "20" | "12.96" | "6101" | "4"       | "0"     | "00"      |
