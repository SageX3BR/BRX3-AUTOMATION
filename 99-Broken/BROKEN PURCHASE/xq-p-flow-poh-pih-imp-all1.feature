...
Feature: xq-p-flow-poh-pih-imp-all1
    ...
    Scenario: 5. Header PIH
        ...
        And the user stores the value of the selected text field with the key: "DOCSUP004"
        Then the user clicks the Close page action icon on the header panel
    ...
    Scenario: 7. Management
        ...
        And the user writes the stored text with key "DOCSUP004" in the selected text field and hits tab key
