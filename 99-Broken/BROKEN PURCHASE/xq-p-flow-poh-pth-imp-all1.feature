...
# Header
# -------------------------------------------------------------------------
# - Test code: xq-p-flow-poh-pth-imp-all1
# - Description: Import receipt create via picking a order with all incidences
# in the NF-e Summary
# - Jira: NA
# - Legislation: BRA
...
Feature: xq-p-flow-poh-pth-imp-all1
    ...
    Scenario Outline: 3. Lines POH
        ...
        Examples:
            ...
            | 1   | "BMS001" | "12"   | "26.65" | "3101" | "0"          | "00"      | "999"  | "49"     | "01"     | "01"     |
            | 2   | "BMS002" | "24"   | "32.48" | "3101" | "0"          | "00"      | "999"  | "49"     | "01"     | "01"     |
    ...
    Scenario Outline: 6. Import Declaration
        ...
        Examples:
            ...
            | "1"    | "1234567890" | "123ABC" | "0.49"  | "4.25"    | "3.15"    | "2.48" | "6.25"   | "Porto de Paranagua" | "PR"     |
            | "2"    | "1234567890" | "ABC123" | "1.25"  | "2.65"    | "4.85"    | "1.65" | "3.26"   | "Porto de Paranagua" | "PR"     |
    ...
    Scenario: 9. Resume
        ...
        And the value of the selected text field is "1,585.0500"
        Then the user clicks the Close page action icon on the header panel
