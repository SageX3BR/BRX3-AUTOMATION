...
# Header
# -------------------------------------------------------------------------
# - Test code: xq-p-flow-poh-pth-imp-pisco
# - Description: Import receipt create via picking a order with
# Sum PIS/COFINS v. to inv. tot. in the NF-e Summary
# - Jira: NA
# - Legislation: BRA
...
Feature: xq-p-flow-poh-pth-imp-pisco
    ...
    Scenario Outline: 3. Lines POH
        ...
        Examples:
            ...
            | 1   | "BMS001" | "13"   | "25.26" | "3101" | "0"          | "00"      | "999"  | "49"     | "01"     | "01"     |
            | 2   | "BMS002" | "21"   | "32.36" | "3101" | "0"          | "00"      | "999"  | "49"     | "01"     | "01"     |
    ...
    Scenario Outline: 6. Import Declaration
        ...
        Examples:
            ...
            | "1"    | "1234567890" | "123ABC" | "1.26"  | "0.35"    | "2.15"    | "4.12" | "3.06"   | "Porto de Paranagua" | "PR"     |
            | "2"    | "1234567890" | "ABC123" | "0.36"  | "4.15"    | "2.51"    | "2.03" | "1.65"   | "Porto de Paranagua" | "PR"     |
    ...
    Scenario: 9. Resume
        ...
        And the value of the selected text field is "1,151.8700"
        Then the user clicks the Close page action icon on the header panel
