...
# Header
# -------------------------------------------------------------------------
# - Test code:xq-p-flow-pnh-fcpst-202
...
Feature:xq-p-flow-pnh-fcpst-202

    Scenario: 1.Login scenario
        Given the user is logged into Sage X3 with "param:loginType" using user name "param:loginUserName" and password "param:loginPassword"

    Scenario: 2. Create PTH - ICMS CST-202
    ...
    Scenario Outline: Add Lines
        ...
        Examples:
            ...
            | 1   | "BMS001" | "10"   | "100.20" | "1102" | "1"       | "0"          | "202"     | "301"  | "02"     | "01"     | "01"     |
            | 2   | "BMS002" | "10"   | "135.00" | "1102" | "1"       | "0"          | "202"     | "301"  | "02"     | "01"     | "01"     |
