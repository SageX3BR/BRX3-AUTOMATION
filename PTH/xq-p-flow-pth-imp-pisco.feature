...
# Header
# -------------------------------------------------------------------------
# - Test code: xq-p-flow-pth-imp-pisco
# - Description: Import receipt with Sum PIS/COFINS v. to inv. tot. in the NF-e Summary
# - Jira: NA
# - Legislation: BRA
...
Feature: xq-p-flow-pth-imp-pisco
    ...
    Scenario Outline: 4. Add Lines
        ...
        Examples:
            ...
            | 1   | "BMS001" | "21"   | "25.32" | "3101" | "0"          | "00"      | "999"  | "49"     | "01"     | "01"     |
            | 2   | "BMS002" | "32"   | "45.62" | "3101" | "0"          | "00"      | "999"  | "49"     | "01"     | "01"     |
    ...
    Scenario Outline: 6. Import Declaration
        ...
        Examples:
            ...
            | "1"    | "1234567890" | "123ABC" | "1.25"  | "3.21"    | "2.69"    | "4.51" | "7.21"   | "Porto de Paranagua" | "PR"     |
            | "2"    | "1234567890" | "ABC123" | "0.32"  | "2.65"    | "4.01"    | "3.23" | "6.03"   | "Porto de Paranagua" | "PR"     |
    ...
    Scenario: 9. Resume
        ...
        And the value of the selected text field is "2,275.0600"
