...
# Header
# -------------------------------------------------------------------------
# - Test code: xq-p-flow-poh-pih-imp-imptx
# - Description: Import receipt create via picking a order with
# Sum import taxes to inv. total in the NF-e Summary
# - Jira: NA
# - Legislation: BRA
...
Feature: xq-p-flow-poh-pih-imp-imptx
    ...
    Scenario Outline: 12. Lines POH
        ...
        Examples:
            ...
            | 1   | "BMS001" | "41"   | "48.98" | "3101" | "0"          | "00"      | "999"  | "49"     | "01"     | "01"     |
            | 2   | "BMS002" | "32"   | "65.36" | "3101" | "0"          | "00"      | "999"  | "49"     | "01"     | "01"     |
    ...
    Scenario: 15. Header PIH
        ...
        And the user stores the value of the selected text field with the key: "DOCSUP047"
        Then the user clicks the Close page action icon on the header panel
    ...
    Scenario: 17. Management
        ...
        And the user writes the stored text with key "DOCSUP047" in the selected text field and hits tab key
    ...
    Scenario Outline: 19. Import Declaration
        ...
        Examples:
            ...
            | "1"    | "1234567890" | "123ABC" | "1.25"  | "2.36"    | "4.58"    | "6.21" | "2.08"   | "Porto de Paranagua" | "PR"     |
            | "2"    | "1234567890" | "ABC123" | "0.65"  | "4.85"    | "1.24"    | "3.62" | "9.65"   | "Porto de Paranagua" | "PR"     |
