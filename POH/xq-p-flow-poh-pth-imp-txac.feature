...
# Header
# -------------------------------------------------------------------------
# - Test code: xq-p-flow-poh-pth-imp-txac
...
Feature: xq-p-flow-poh-pth-imp-txac
    ...
    Scenario Outline: 3. Lines POH
        ...
        Examples:
            ...
            | 1   | "BMS001" | "12"   | "26.36" | "3101" | "0"          | "00"      | "999"  | "49"     | "01"     | "01"     |
            | 2   | "BMS002" | "21"   | "42.32" | "3101" | "0"          | "00"      | "999"  | "49"     | "01"     | "01"     |
    ...
    Scenario Outline: 6. Import Declaration
        ...
        Examples:
            ...
            | "1"    | "1234567890" | "123ABC" | "1.02"  | "2.36"    | "4.32"    | "0.99" | "5.12"   | "Porto de Paranagua" | "PR"     |
            | "2"    | "1234567890" | "ABC123" | "0.36"  | "4.25"    | "2.13"    | "0.51" | "3.15"   | "Porto de Paranagua" | "PR"     |
    ...
    Scenario: 9. Resume
        ...
        And the value of the selected text field is "17.6000"
        Then the user clicks the Close page action icon on the header panel
